...
%% triggers and events
% 不区分干扰存在与否
fix_loc = [120,122,123,124];   % 目标出现在高概率干扰位置
right    = [130,131,133,134];   %  目标出现在右侧
left       = [140,141,142,144];   % 目标出现在左侧 
opp_loc  = [150,151,152,153];   % 目标出现在高概率干扰位置对侧
...
for subno = 1:length(sublist)
    ...
    cfg.writdir = [filepath filesep 'TF_tcond']; 
